...
typedef struct{
    ...
    uint8_t breath_voc_equivalentAccuracy;
} dataContainer;

extern dataContainer dataStorage;
extern int64_t time_stamp_interval_ms;
/**********************************************************************************************************************/
...
return_values_init bsec_iot_init(float sample_rate, float temperature_offset, bme68x_write_fptr_t bus_write, bme68x_read_fptr_t bus_read, 
    sleep_fct sleep_n, state_load_fct state_load, config_load_fct config_load);
